# Algorithm Registry — All 38 Algorithm Definitions
**File path in RN project:** `src/features/algorithms/data/algorithmRegistry.ts`
...
/** Search algorithms by name or tag */
...
/** Get total count by category (for progress) */
